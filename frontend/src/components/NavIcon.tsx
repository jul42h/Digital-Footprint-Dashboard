...
const PATHS: Record<IconName, string> = {
  ...
  insights:
    "M11 3l1.4 4.2L16.6 8.6 12.4 10l-1.4 4.2L9.6 10 5.4 8.6 9.6 7.2 11 3zm7.5 9l.9 2.6L22 15.5l-2.6.9-.9 2.6-.9-2.6-2.6-.9 2.6-.9.9-2.6z",
  issues:
  ...
  users:
    "M8.5 11a3 3 0 100-6 3 3 0 000 6zm0 2c-3 0-6 1.5-6 4v2h12v-2c0-2.5-3-4-6-4zm7.5-2a2.5 2.5 0 100-5 2.5 2.5 0 000 5zm0 1.5c-.65 0-1.27.08-1.85.24.9.8 1.6 1.9 1.85 3.26H21v-1c0-1.7-2.35-2.5-5-2.5z",
